...
#pragma warning restore CS1591
        ...
        [ProducesResponseType(500)]
        public async Task<IActionResult> GetStockItemsAsync(int id)
        {
            Logger?.LogDebug("'{0}' has been invoked", nameof(GetStockItemsAsync));
            ...
            {
                response.DidError = true;
                response.ErrorMessage = "There was initial error, please contact to technical support.";
        ...
        [ProducesResponseType(500)]
        public async Task<IActionResult> PostStockItemAsync([FromBody] PostStockItemRequest request)
        {
            Logger?.LogDebug("'{0}' has been involved", nameof(PostStockItemAsync));
            ...
            try
            {
                ...
                //Create enetity form request model
            ...
            catch(Exception ex)
            {
                ...
                Logger?.LogCritical("There is an error on '{0}' invocation: {1}", nameof(PostStockItemAsync), ex);
            }
            return response.ToHttpResponse();
        }
